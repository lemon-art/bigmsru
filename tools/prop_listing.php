...
$APPLICATION->SetTitle("Настройка листинга выводимых свойств в списке товаров");
...
if ( $_GET["SECTION_ID"] ){
	...
	$listFile = $_SERVER["DOCUMENT_ROOT"]."/tools/files/listing_prop_".$IBLOCK_ID.".txt";
...
<div class="conteiner">
	...
	<div class="col-md-8">
		<?if ( $_GET["SECTION_ID"] ):?>
			...
			<a href="#" id="show_props">Добавить/редактировать свойства на листинг товаров</a>
