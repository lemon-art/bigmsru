...
$title = '';
if ($ar_result['DEPTH_LEVEL'] == 7 && !array_search($APPLICATION->GetCurPage(false), $arUrlData)) {
...
?>
				...
				$APPLICATION->IncludeComponent(
					...
					<div class="content-adv__buttons">
					  <a href="/smeta/" class="button button_yel content-adv__button">Быстрый расчёт сметы</a>
