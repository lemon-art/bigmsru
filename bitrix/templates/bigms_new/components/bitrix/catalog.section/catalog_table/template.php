	...
	<tr class="item" id="<? echo $strMainID; ?>">
		...
		<td class="title_block">
			...
			<div class="do_block">
				...
				<a class="share_button" href="javascript:void(0)" data-id="<?=$arItem["ID"]?>" onclick="add2delay('<?=$arItem["ID"]?>','<?=$arItem["CATALOG_PRICE_ID_1"]?>','<?=$arItem["CATALOG_PRICE_1"]?>','<?=addslashes($arItem["NAME"]);?>','<?=$arItem["DETAIL_PAGE_URL"]?>'); yaCounter31721621.reachGoal('add_to_bookmarks');"><span><?=GetMessage('CT_BCS_TPL_MESS_BTN_SHARE')?></span></a>
			</div>
		</td>
