...
if (!empty($arResult['ITEMS'])):?>
    ...
    <section class="demanded-products">
        <h2 class="content-h2">Востребованные товары</h2>
            <div id="demanded-products" class="demanded-products__wrap right-shadow">
                <ul class="demanded-products__list">
							...
							<div class="product-card__info">
							  ...
							  <div class="product-card__row product-card__row_between">
									...
									<?elseif( $arItem['PROPERTIES']['DELIVERY_TIME']['VALUE'] && $arItem["CATALOG_QUANTITY"] <= 0 ):?>
										...
										<span class="product-card__quantity product-card__quantity_order">Под заказ
										</span>
