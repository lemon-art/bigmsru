...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-20 col-md-20 col-sm-20">
			...
			<form action="<?=$APPLICATION->GetCurPage();?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data" class="content-order__form form form_order">
