...
switch ($arCurrentValues["CATEGORY"]) {
    case $CurrentCategory:
        ...
        else
        {
            ...
            $arTemplateParameters['BRANDS_TOMORROW'] = Array(
              "PARENT" => "OPTIONAL_PARAMS",
              "NAME" => GetMessage('BRANDS_TOMORROW'),
              "TYPE" => "STRING",
               "MULTIPLE" => "Y",
            );
            $arTemplateParameters['BRANDS_FREE'] = Array(
              "PARENT" => "OPTIONAL_PARAMS",
              "NAME" => GetMessage('BRANDS_FREE'),
              "TYPE" => "STRING",
               "MULTIPLE" => "Y",
            );
            $arTemplateParameters['BRANDS_300'] = Array(
              "PARENT" => "OPTIONAL_PARAMS",
              "NAME" => GetMessage('BRANDS_300'),
              "TYPE" => "STRING",
               "MULTIPLE" => "Y",
            );
            $arTemplateParameters['BRANDS_AVAILABLE'] = Array(
              "PARENT" => "OPTIONAL_PARAMS",
              "NAME" => GetMessage('BRANDS_AVAILABLE'),
              "TYPE" => "STRING",
               "MULTIPLE" => "Y",
            );
        }
