...
if($page == "/index.php"):
?>
	<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/main_str.js"></script>
<?endif;?>
<?
$page = $APPLICATION->GetCurPage(true);
if($page == "/kontakty/index.php"):
?>
	<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/main_cont.js"></script>
<?endif;?>
...
$page = $APPLICATION->GetCurPage(true);
if($page == "/kontakty/index.php"){
	$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/js/main_cont.js");
}*/
?>
