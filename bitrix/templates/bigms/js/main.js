...
/*
var catalogs1_header = $(".catalogs1_header");
$.ajax({
	url: '/ajax/catalog_main_menu.php?type=i',
	type: 'POST',
	cache: false,
	dataType: 'html',
	...
	success: function( respond, textStatus, jqXHR ){
		catalogs1_header.html(respond);
	},
	error: function( jqXHR, textStatus, errorThrown ){
	}
});
var catalogs2_header = $(".catalogs2_header");
$.ajax({
	url: '/ajax/catalog_main_menu.php?type=b',
	type: 'POST',
	cache: false,
	dataType: 'html',
	processData: false, // �� ������������ ����� (Don't process the files)
...
function catalog_active_ss(val, prefix, class_brand) {
	$("." + class_brand).addClass("active").siblings().removeClass("active");
