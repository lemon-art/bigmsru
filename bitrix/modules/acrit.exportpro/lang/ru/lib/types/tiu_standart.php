...
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_BID"] = "Основная ставка клика";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_AVAILABLE"] = "Cтатус доступности товара";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_URL"] = "URL страницы товара.<br>Максимальная длина URL — 512 символов.<br>Необязательный элемент для магазинов-салонов";
...
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_AUTHOR"] = "Автор произведения";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_NAME"] = "Название произведения.<br><b>Обязательный элемент</b>";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_PUBLISHER"] = "Издательство";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_SERIES"] = "Серия";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_YEAR"] = "Год издания";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_ISBN"] = "Код книги";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_VOLUME"] = "Номер тома";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_PART"] = "Номер части";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_LANGUAGE"] = "Язык произведения";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_TABLEOFCONTENTS"] = "Оглавление.<br>Выводится информация о названиях произведений,<br>если это сборник рассказов или стихов";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_PERFORMEDBY"] = "Исполнитель";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_PERFORMANCETYPE"] = "Тип аудиокниги";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_STORAGE"] = "Носитель, на котором поставляется аудиокнига";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_FORMAT"] = "Формат аудиокниги";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_RECORDINGLENGTH"] = "Время звучания задается в формате mm.ss (минуты.секунды)";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_DESCRIPTION"] = "Аннотация к книге.<br>Длина текста не более 175 символов (не включая знаки препинания),<br> запрещено использовать HTML-теги <br>(информация внутри тегов публиковаться не будет)";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_DOWNLOADABLE"] = "Элемент предназначен для обозначения товара, который можно скачать";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_AGE"] = "Возрастная категория товара";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_STORE"] = "Покупка соответствующего товара в розничном магазине<br>Возможные значения: true, false";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_PICKUP"] = "Возможность зарезервировать выбранный товар и забрать его самостоятельно<br>Возможные значения: true, false";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_DELIVERY"] = "Возможность доставки<br>Возможные значения: true, false";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_LOCALDELIVERYCOST"] = "Стоимость доставки данного товара в своем регионе";
...
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_SALESNOTES"] = "Элемент используется для отражения информации<br>о минимальной сумме заказа, минимальной партии<br>товара или необходимости предоплаты, а так же для<br>описания акций, скидок и распродаж.<br>Допустимая длина текста в элементе — 50 символов";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_MANUFACTURERWARRANTY"] = "Гарантия<br>Возможные значения: true, false";
...
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_ADULT"] = "Элемент обязателен для обозначения товара,<br> имеющего отношение к удовлетворению сексуальных потребностей";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_BARCODE"] = "Штрихкод товара, указанный производителем";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_CPA"] = "Участие товарных предложений в программе «Заказ на Маркете»";
...
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_REC"] = "Рекомендуемые товары для покупки вместе с текущим";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_EXPIRY"] = "Срок годности";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_WEIGHT"] = "Веса товара.<br><b>Вес указывается в килограммах с учетом упаковки</b>";
$MESS["ACRIT_EXPORTPRO_TIU_PORTAL_CATEGORY_SIMPLE_FIELD_DIMENSIONS"] = "Габариты товара (длина, ширина, высота) в упаковке.<br><b>Размеры указываются в сантиметрах</b>";
