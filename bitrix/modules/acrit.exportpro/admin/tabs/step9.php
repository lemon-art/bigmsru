            ...
            <tbody>
                ...
                <tr id="tr_cron_info" class="<?=$hideCronInfo?>">
                    <td colspan="2">
                        ...
                        <b><?=$_SERVER["ACRIT_EXPORTPRO_DOCUMENT_ROOT"];?>/bitrix/crontab/crontab.cfg</b>
                        ...
                        <?=GetMessage( "ACRIT_EXPORTPRO_CES_NOTES8" );?><br>
                            <textarea name="crontasks" cols="70" rows="5" wrap="off" readonly><?foreach ($arRetval as $stRetval):?><?if(strlen($stRetval)>strlen(PHP_EOL)):?>
                        	<?=htmlspecialcharsbx($stRetval)."\n";?>
	                        <?endif;?><?endforeach;?></textarea><br>
                        <?}?>
