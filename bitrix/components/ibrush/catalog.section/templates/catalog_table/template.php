		...
		<td class="bx_catalog_item_controls"><?
			if ($arItem['CAN_BUY'])
			{
				...
				<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
					...
					<div class="byclick">
						<a href="#" data-id="<?=$arItem["ID"]?>" data-iblock="<?=$arItem["IBLOCK_ID"]?>" class="buy_one_button_table" onclick="yaCounter31721621.reachGoal('catalog-oneclickbuy-button');">купить в 1 клик</a>
					</div>
