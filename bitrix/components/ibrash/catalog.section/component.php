<?
/*
	Модифицирован компонент для поддержки вывода информации из нескольких информационных блоков.
*/
...
$arParams["IBLOCK_ID"] = $arParams["IBLOCK_ID"];//$arParams["IBLOCK_ID"] = (int)$arParams["IBLOCK_ID"];
