			...
			<div class="bx-system-auth-table">
				...
				<? foreach ($arResult["SHOW_FIELDS"] as $FIELD): ?>
					<? if ($FIELD == "AUTO_TIME_ZONE" && $arResult["TIME_ZONE_ENABLED"] == true): ?>
						<div class="field">
							<div class="label"><? echo GetMessage("main_profile_time_zones_auto") ?>:<? if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?><span class="asterisk">*</span><? endif ?></div>
							<div>
						...
						<div class="field">
							<div class="label"><? echo GetMessage("main_profile_time_zones_zones") ?>:</div>
							<div>
					...
					<? else: ?>
						<div class="field">
							<?if ($FIELD != "WORK_COMPANY"){?>
								<div class="label"><?= GetMessage("REGISTER_FIELD_".$FIELD) ?>:<? if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?><span	class="asterisk">*</span><? endif ?>
								</div>
							<?}?>
							<div><?
								switch ($FIELD)
				...
				<? endforeach ?>
					...
					<div class="field">
						<div class="uf_type">
							...
							<input type="checkbox" id="type2" name="UF_TYPE" value="2">
							<label for="type2">Я юридическое лицо</label>
							<br>
						</div>
					</div>
					<div class="ur_lico hidden">
						<div class="field">
							...
							<div><input type="text" value="" name="REGISTER[WORK_COMPANY]" size="30"></div>
						</div>
						<div class="field">
							<div class="label">ИНН:</div>
							<div><input type="text" class="fields string" size="60" value="" name="UF_INN"></div>
						</div>
					</div>
				...
				if ($arResult["USE_CAPTCHA"] == "Y"):?>
					...
					<div class="field">
						<div class="label"><?= GetMessage("REGISTER_CAPTCHA_PROMT") ?>:<span class="asterisk">*</span></div>
